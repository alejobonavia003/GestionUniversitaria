...
public abstract class PersonaAbs extends Model {
  ...
  public Estudiante getEstudiante() {
    return Estudiante.findFirst("dni = ?", getDni());
  }

  public Profesor getProfesor() {
    return Profesor.findFirst("dni = ?", getDni());
  }

  public java.util.List<Cursa> getCursas() {
    return Cursa.find("dni = ?", getDni());
  }

  public java.util.List<Dicta> getDictas() {
    return Dicta.find("dni_prof = ?", getDni());
  }

  public java.util.List<Rindio> getRindios() {
    return Rindio.find("dni = ?", getDni());
  }
}
